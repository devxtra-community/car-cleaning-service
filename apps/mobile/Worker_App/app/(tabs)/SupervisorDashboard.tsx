...
import { View, Text, Pressable, ScrollView, StatusBar, Image, ActivityIndicator } from 'react-native';
        ...
        <View className="flex-1 bg-white">
            ...
            >
                <View className="flex-row items-center mb-6">
                    <View
                        className={`w-[60px] h-[60px] rounded-full bg-white justify-center items-center mr-4 shadow-md border-2 border-[#E0F2FE] ${user?.profile_image ? 'p-0 overflow-hidden' : ''
                            }`}
                    >
                        {user?.profile_image ? (
                ...
                <View className="bg-white p-6 mb-6 border border-[#F1F5F9] shadow-xl rounded-3xl">
                    ...
                    <View className="flex-row items-baseline mb-4">
                        ...
                        <View className="bg-[#10B9811A] px-[10px] py-[4px] rounded-xl ml-3">
                            <Text className="text-xs font-bold text-[#059669]">+12%</Text>
                        </View>
                    </View>
                    ...
                    <View className="flex-row justify-between">
                        <View className="items-center">
                            <Text className="text-base font-bold text-[#1E293B]">30</Text>
                            <Text className="text-[10px] text-[#64748B] font-semibold mt-[2px]">
                                Jobs Done
                            </Text>
                        </View>
                        <View className="items-center">
                            <Text className="text-base font-bold text-[#1E293B]">04</Text>
                            <Text className="text-[10px] text-[#64748B] font-semibold mt-[2px]">
                                Pending
                            </Text>
                        </View>
                        <View className="items-center">
                            <Text className="text-base font-bold text-[#1E293B]">98%</Text>
                            <Text className="text-[10px] text-[#64748B] font-semibold mt-[2px]">
                                Rating
                            </Text>
                        </View>
                ...
                <View className="flex-row gap-3 mb-6">
                    ...
                    >
                        ...
                        >
                            ...
                            <Text className="text-white text-base font-bold flex-1 ml-3">
                                Add Tasks
                            </Text>
