                                ...
                                <View className="flex-row items-center gap-3">
                                    ...
                                    <View>
                                        ...
                                        <View className="flex-row items-center gap-1">
                                            <View className={`w-2 h-2 rounded-full ${worker.status === 'working' ? 'bg-green-500' : 'bg-gray-300'}`} />
                                ...
                                {worker.task_started_at && (
                                    <View className="bg-blue-50 px-3 py-1.5 rounded-full flex-row items-center gap-1.5">
                                        ...
                                        <Text className="text-[10px] font-bold text-[#0EA5E9]">
                                            Started {new Date(worker.task_started_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                                        </Text>
                                    </View>
                                )}
                            </View>
                            ...
                            {worker.status === 'working' ? (
                                <View className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                                    <View className="flex-row items-center gap-3 mb-3">
                                        ...
                                        <View>
                                            <Text className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Active Vehicle</Text>
