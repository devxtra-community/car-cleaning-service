...
export default function FloorOverview() {
    ...
    const onRefresh = () => { setRefreshing(true); loadFloors(); };
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#F8FAFC', paddingTop: insets.top }}>
            ...
            <View style={{ padding: 20, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#E2E8F0' }}>
                <Text style={{ fontSize: 22, fontWeight: '800', color: '#1E293B' }}>Floor Overview</Text>
                <Text style={{ fontSize: 12, color: '#94A3B8', marginTop: 4 }}>
                    {data?.building_name ?? 'Your building'} — today's operational status
                </Text>
            </View>
                                ...
                                >
                                    ...
                                    <View style={{ flexDirection: 'row', gap: 10, marginBottom: 14 }}>
                                        <View style={{ flex: 1, backgroundColor: '#F0F9FF', borderRadius: 10, padding: 12, alignItems: 'center' }}>
                                            ...
                                            <Text style={{ fontSize: 18, fontWeight: '800', color: '#1B86C6', marginTop: 4 }}>
                                                {floor.cleaners_count ?? '—'}
                                            </Text>
                                            <Text style={{ fontSize: 10, color: '#94A3B8', textTransform: 'uppercase', marginTop: 2 }}>
                                                Cleaners
                                            </Text>
                                        </View>
                                    ...
                                    {target > 0 && (
                                        <View>
                                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 }}>
                                                ...
                                                <Text style={{ fontSize: 11, fontWeight: '700', color: barColor }}>{progress}%</Text>
                                            </View>
                                            <View style={{ height: 6, backgroundColor: '#E2E8F0', borderRadius: 99 }}>
                                                <View style={{ height: 6, borderRadius: 99, backgroundColor: barColor, width: `${progress}%` }} />
                                            </View>
                                        </View>
                                    )}
                                </View>
