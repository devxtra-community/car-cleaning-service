...
const ACCESS_EXPIRES_WEB = process.env.JWT_ACCESS_EXPIRES_WEB;
const ACCESS_EXPIRES_MOBILE = process.env.JWT_ACCESS_EXPIRES_MOBILE;
const REFRESH_EXPIRES_WEB = process.env.JWT_REFRESH_EXPIRES_WEB;
const REFRESH_EXPIRES_MOBILE = process.env.JWT_REFRESH_EXPIRES_MOBILE;
